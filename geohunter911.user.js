...
// @version      2025-06-22b
// @description  HUD: Kontinent / Land / Bundesstaat / Stadt + Minikarte (auto-update)
...
(() => {
  ...
  async function refresh() {
    ...
    const key = `${pos.lat.toFixed(4)},${pos.lon.toFixed(4)}`;   // 10-m Raster
